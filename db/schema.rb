...
ActiveRecord::Schema[7.1].define(version: 2025_04_04_054920) do
  ...
  create_table "group_chat_messages", force: :cascade do |t|
    t.integer "group_chat_room_id", null: false
    t.integer "user_id"
    t.text "content"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["group_chat_room_id"], name: "index_group_chat_messages_on_group_chat_room_id"
  ...
  add_foreign_key "group_chat_messages", "group_chat_rooms"
